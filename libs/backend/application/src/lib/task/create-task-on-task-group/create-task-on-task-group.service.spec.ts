...
import { CreateTaskOnTaskGroupService } from './create-task-on-task-group.service';
import { CreateTaskOnTaskGroupServiceInput } from './create-task-on-task-group.service.interface';

describe('CreateTaskOnTaskGroupService', () => {
  let service: CreateTaskOnTaskGroupService;
  ...
  beforeEach(() => {
    service = new CreateTaskOnTaskGroupService(
      taskRepository,
  ...
  describe('正常系', () => {
    const input: CreateTaskOnTaskGroupServiceInput = {
